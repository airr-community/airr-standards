...
```{r read_repertoire }
rep_file_bad <- "/home/katharina/Documents/synced/science_projects/method_development/AIRR/airr-standards/lang/R/tests/data-tests/bad_repertoire.airr.yaml"
rep_file_good <- "/home/katharina/Documents/synced/science_projects/method_development/AIRR/airr-standards/lang/R/tests/data-tests/good_repertoire.airr.yaml"
```

```{r}
airr_rearrangement <- read_repertoire(rep_file_good)
```

```{r}

airr_rearrangement <- read_repertoire(rep_file_bad)
```
