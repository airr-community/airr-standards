...
```{r read_repertoire }
rep_file_bad <-  system.file("tests/data-tests/", "bad_repertoire.airr.yaml", package="airr")
rep_file_good <- system.file("tests/data-tests/", "good_repertoire.airr.yaml", package="airr")
```
...
Read an incomplete repertoire
```{r}
repertoire2 <- read_repertoire(rep_file_bad)
```
...
Write a valid repertoire
```{r}
out_file1 <- file.path(tempdir(), "airr_repertoire1_out.yaml")
write_repertoire(repertoire1, out_file1)
```

Write an incomplete repertoire
```{r}
out_file2 <- file.path(tempdir(), "airr_repertoire2_out.yaml")
